...
const categories = [
  ...
  { label: 'Siêu thị & TTTM',      href: '/du-an/sieu-thi-tttm',     count: 6  },
  { label: 'Nhà máy & Khu CN',     href: '/du-an/nha-may-khu-cn',    count: 6  },
  { label: 'Khách sạn',            href: '/du-an/khach-san',          count: 2  },
  { label: 'Cao tầng & Căn hộ',    href: '/du-an/cao-tang-can-ho',   count: 4  },
...
const projectGroups = [
  {
    ...
    projects: [
      { slug: 'bigc-thang-long',       name: 'Big C Thăng Long (GO! Thăng Long)', detail: 'Hà Nội', systems: ['Sprinkler tự động', 'Báo cháy tự động', 'Hosereel'], img: '/images/duan2/bigc-thang-long.jpg' },
      { slug: 'bigc-an-lac',           name: 'Big C An Lạc (GO! An Lạc)', detail: 'TP. Hồ Chí Minh', systems: ['Sprinkler', 'Chữa cháy vách tường', 'Báo cháy'], img: '/images/duan2/bigc-an-lac.jpg' },
      { slug: 'bigc-can-tho',          name: 'Big C Cần Thơ (GO! Cần Thơ)', detail: 'Cần Thơ', systems: ['Sprinkler', 'Báo cháy tự động', 'Màn cuốn ngăn khói'], img: '/images/duan2/bigc-tong.jpg' },
      { slug: 'mm-mega-market-an-phu', name: 'MM Mega Market An Phú', detail: 'TP. Hồ Chí Minh', systems: ['Sprinkler tự động', 'Hosereel & Hydrant', 'Họng nước cứu hỏa'], img: '/images/duan2/metro-an-phu.jpg' },
      { slug: 'mm-mega-market-hiep-phu', name: 'MM Mega Market Hiệp Phú', detail: 'TP. Hồ Chí Minh', systems: ['Sprinkler tự động', 'Hosereel & Hydrant', 'Họng nước cứu hỏa'], img: '/images/duan2/metro-hiep-phu.jpg' },
      { slug: 'mm-mega-market-binh-phu', name: 'MM Mega Market Bình Phú', detail: 'TP. Hồ Chí Minh', systems: ['Sprinkler tự động', 'Chữa cháy vách tường', 'Đèn thoát hiểm sự cố'], img: '/images/duan2/metro-an-phu.jpg' },
    ],
  },
  {
    ...
    projects: [
      { slug: 'intel-viet-nam',      name: 'Intel Việt Nam', detail: 'Bình Dương', systems: ['FM200', 'Báo cháy địa chỉ', 'Sprinkler', 'Camera'], img: '/images/duan2/khu-cong-nghiep.jpg' },
      { slug: 'colgate-palmolive',   name: 'Nhà máy Colgate Palmolive', detail: 'Bình Dương', systems: ['Sprinkler tự động', 'Chữa cháy vách tường', 'Họng nước'], img: '/images/duan2/colgate.jpg' },
      { slug: 'robert-bosch',        name: 'Nhà máy Robert Bosch', detail: 'Đồng Nai', systems: ['Sprinkler tự động', 'Báo cháy tự động', 'Hosereel'], img: '/images/duan2/nha-may.jpg' },
      { slug: 'frieslandcampina',    name: 'FrieslandCampina Việt Nam', detail: 'Bình Dương', systems: ['Hệ thống Sprinkler tự động'], img: '/images/duan2/colgate.jpg' },
      { slug: 'shell-go-dau',        name: 'Shell Gò Dầu (TOP Solvent)', detail: 'Đồng Nai', systems: ['Chữa cháy Foam', 'Báo cháy tự động', 'Hosereel'], img: '/images/duan2/shell-go-dau.jpg' },
      { slug: 'intersnack',          name: 'Nhà máy Intersnack', detail: 'Đồng Nai', systems: ['Sprinkler', 'Chữa cháy vách tường', 'Bình chữa cháy'], img: '/images/duan2/khu-cong-nghiep.jpg' },
    ],
  },
  {
    ...
    projects: [
      { slug: 'majestic-hotel',      name: 'Khách sạn Majestic', detail: 'TP. Hồ Chí Minh', systems: ['Chữa cháy tự động', 'Chữa cháy vách tường', 'Báo cháy'], img: '/images/duan2/khach-san.jpg' },
      ...
      { slug: 'hung-ngan',           name: 'Khu cao tầng Hưng Ngân', detail: 'TP. Hồ Chí Minh', systems: ['Hệ thống PCCC & chống sét Block B1'], img: '/images/duan2/trung-tam.jpg' },
      { slug: 'imperial-vung-tau',   name: 'The Imperial Residences', detail: 'Vũng Tàu', systems: ['Sprinkler', 'Chữa cháy vách tường', 'Báo cháy'], img: '/images/duan2/trung-tam.jpg' },
      { slug: 'riviera-point',       name: 'Riviera Point Quận 7', detail: 'TP. Hồ Chí Minh', systems: ['Thiết kế PCCC', 'Hệ thống chống sét'], img: '/images/duan2/trung-tam.jpg' },
    ],
  },
  {
    ...
    projects: [
      { slug: 'ubnd-hcm',            name: 'Trụ sở UBND TP. Hồ Chí Minh', detail: 'TP. Hồ Chí Minh', systems: ['Camera quan sát', 'Báo cháy tự động'], img: '/images/duan2/du-an-khac.jpg' },
      { slug: 'ubnd-dong-nai',       name: 'Trụ sở UBND Tỉnh Đồng Nai', detail: 'Đồng Nai', systems: ['Camera', 'Chống sét', 'Báo cháy'], img: '/images/duan2/du-an-khac.jpg' },
      { slug: 'thu-vien-dong-nai',   name: 'Thư Viện Tỉnh Đồng Nai', detail: 'Đồng Nai', systems: ['Báo cháy tự động', 'Hệ thống chống sét'], img: '/images/duan2/du-an-khac.jpg' },
    ],
  },
]
