...
const projectGroups = [
  {
    ...
    projects: [
      { slug: 'bigc-nha-trang', name: 'Big C Nha Trang (Go! Nha Trang)', location: 'Nha Trang', systems: ['Sprinkler tự động và báo cháy tự động', 'Chữa cháy vách tường', 'Chữa cháy khí sạch cho phòng Server','Hệ thống Cửa trượt chống cháy và Cửa thoát hiểm','Hệ thống đèn chiếu sáng sự cố và thoát hiểm'], img: '/images/projects/bigcnhatrang.jpg' },
      { slug:'bigc-ninh-binh',name: 'Big C Ninh Bình (Go! Ninh Bình)', location: 'Ninh Bình', systems: ['Sprinkler tự động và báo cháy tự động', 'Chữa cháy vách tường', 'Chữa cháy khí sạch cho phòng Server','Hệ thống Cửa trượt chống cháy và Cửa thoát hiểm','Hệ thống đèn chiếu sáng sự cố và thoát hiểm','Chữa cháy tự động bằng CO2'], img: '/images/projects/ninhbinh.jpg' },
  ...
  },
  {
    ...
    projects: [
      ...
      { slug: 'tata-coffee',   name: 'Nhà máy Tata Coffee', detail: 'Bình Dương', systems: ['Sprinkler tự động', 'Chữa cháy vách tường', 'Bình chữa cháy xách tay'], img: '/images/projects/tata.png' },
      ...
      { slug: 'olam',    name: 'Công Ty TNHH Chế Biến Thực Phẩm Olam Việt Nam', detail: 'Đồng Nai', systems: ['Sprinkler tự động', 'Hệ thống báo cháy', 'Bình chữa cháy xách tay', 'Chữa cháy vách tường '], img: '/images/projects/olam.jpg' },
      { slug: 'top-solvent',        name: 'Nhà máy TOP Solvent (Shell Gò Dầu)', detail: 'Đồng Nai', systems: ['Chữa cháy vách tường trong và ngoài nhà', 'Hệ thống Báo cháy tự động'], img: '/images/projects/solvent2.webp' },
