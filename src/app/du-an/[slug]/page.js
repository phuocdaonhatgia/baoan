...
const allProjects = [
  ...
  { slug: 'top-solvent', name: 'Nhà máy TOP Solvent (Shell Gò Dầu) ', type: 'Nhà máy & Khu CN', location: 'KCN Gò Dầu, Xã Phước Thái, TP Đồng Nai, Việt Nam', year: '2012', systems: ['Chữa cháy vách tường trong và ngoài nhà', 'Hệ thống Báo cháy tự động'], images: ['/images/projects/solvent2.webp','/images/projects/solvent1.jpg','/images/projects/solvent3.jpg'] },
  ...
  { slug: 'novotel-da-nang', name: 'Khách sạn Novotel Đà Nẵng', type: 'Khách sạn', location: 'Số 36 Bạch Đằng, phường Hải Châu, quận Hải Châu, thành phố Đà Nẵng', year: '2013', systems: ['Hệ thống chữa cháy tự động khí CO2', 'Hệ thống chữa cháy khí FM200 cho phòng Server'], images: ['/images/projects/novotel.jpg','/images/projects/novotel1.jpg','/images/projects/novotel.jpg'] },
  { slug: 'hung-ngan', name: 'Khu nhà ở cao tầng Hưng Ngân', type: 'Cao tầng & Căn hộ', location: 'TP. Hồ Chí Minh', year: '2012', systems: ['Hệ thống PCCC và chống sét Block B1'], images: ['/images/projects/trung-tam.jpg'] },
  { slug: 'imperial-vung-tau', name: 'The Imperial Residences', type: 'Cao tầng & Căn hộ', location: 'Vũng Tàu', year: '2014', systems: ['Hệ thống Sprinkler', 'Hệ thống chữa cháy vách tường', 'Hệ thống báo cháy tự động'], images: ['/images/projects/trung-tam.jpg'] },
  { slug: 'riviera-point', name: 'Residential Area Riviera Point', type: 'Cao tầng & Căn hộ', location: 'TP. Hồ Chí Minh', year: '2015', systems: ['Thiết kế PCCC', 'Hệ thống chống sét'], images: ['/images/projects/trung-tam.jpg'] },
  { slug: 'ubnd-hcm', name: 'Trụ sở UBND TP. Hồ Chí Minh', type: 'Công trình công cộng', location: 'TP. Hồ Chí Minh', year: '2005', systems: ['Hệ thống camera quan sát', 'Hệ thống báo cháy tự động'], images: ['/images/projects/du-an-khac.jpg'] },
  { slug: 'ubnd-dong-nai', name: 'Trụ sở UBND Tỉnh Đồng Nai', type: 'Công trình công cộng', location: 'Đồng Nai', year: '2005', systems: ['Camera quan sát', 'Hệ thống chống sét', 'Báo cháy tự động'], images: ['/images/projects/du-an-khac.jpg'] },
  { slug: 'thu-vien-dong-nai', name: 'Thư Viện Tỉnh Đồng Nai', type: 'Công trình công cộng', location: 'Đồng Nai', year: '2004', systems: ['Hệ thống báo cháy tự động', 'Hệ thống chống sét'], images: ['/images/projects/du-an-khac.jpg'] },
]
