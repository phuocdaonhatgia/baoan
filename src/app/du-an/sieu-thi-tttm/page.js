...
const projects = [
  ...
  { slug: 'bigc-thang-long', name: 'Big C Thăng Long (GO! Thăng Long)', type: 'Siêu thị & TTTM', location: 'Hà Nội', year: '2010', systems: ['Hệ thống Chữa cháy tự động', 'Họng nước cứu hỏa', 'Hệ thống chữa cháy vách tường', 'Hệ thống báo cháy tự động', 'Hệ thống chữa cháy làm mát bồn dầu'], img: '/images/projects/biggg.jpg' },
  ...
  {slug: 'mm-mega-market-bien-hoa', name: 'MM Mega Market Biên Hoà', location: 'Đồng Nai', systems: ['Hệ thống chữa cháy tự động Sprinkler và tường nước', 'Hệ thống chữa cháy Hydrant ngoài nhà', 'Hệ thống chữa cháy vách tường và bình chữa cháy', 'Hệ thống đèn chiếu sáng sự cố, thoát hiểm'], img: '/images/projects/bien hoa.jpg' },
  { slug:'mm-mega-market-thanh-xuan', name: 'MM Mega Market Thanh Xuân', location: 'Hồ Chí Minh', systems: ['Hệ thống chữa cháy tự động Sprinkler', 'Chữa cháy khí sạch cho phòng Server', 'Hệ thống báo cháy tự động', 'Hệ thống Màn cuốn tự động ngăn khói cháy'], img: '/images/projects/thanh xuan.jpg' },
  {slug:"metro-ha-dong", name: 'Metro Hà Đông', location: 'Hà Nội', systems: ['Hệ thống chữa cháy tự động Sprinkler', 'Hệ thống chữa cháy vách tường và bình chữa cháy'], img: '/images/projects/metrohadong.jpg' },
